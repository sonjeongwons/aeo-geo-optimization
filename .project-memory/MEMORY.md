...
- [Project: sharejoa onboarding](project-sharejoa-onboarding.md) — 4th customer (쉐어조아) — 6 real bugs fixed & verified; remaining gap is open-ended claim-matching precision, not a quick fix
